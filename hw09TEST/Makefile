...
OFILES = font.o StartScreen.o Cookie.o GameOver.o GameWon.o Fire.o myLib.o text.o Game.o main.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h StartScreen.h GameOver.h GameWon.h Cookie.h Fire.h
